 ...
 */
 ...
 // We needed to copy network.js since it is giving problems in release mode when built with dojo

'use strict';

(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    define('pdfjs/core/network_copy', ['exports', 'pdfjs/shared/util',
...
if (typeof PDFJSDev !== 'undefined' && PDFJSDev.test('FIREFOX || MOZCENTRAL')) {
  ...
  if (coreWorker && coreWorker.setPDFNetworkStreamClass ) {
